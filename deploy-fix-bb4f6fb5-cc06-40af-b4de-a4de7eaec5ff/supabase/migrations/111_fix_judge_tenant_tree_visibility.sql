-- 111_fix_judge_tenant_tree_visibility.sql
-- Include child-tenant registrations through their tenant's organisation link
-- while retaining token, schedule, festival, item and code-letter boundaries.
