sql_content = '''CREATE OR REPLACE FUNCTION public.get_leaderboard_preview(
  p_tenant_id uuid,
  p_festival_id uuid,
  p_ranking_mode text,
...
with open('supabase/migrations/173_leaderboard_preview_rpc.sql', 'w', encoding='utf-8') as f:
    f.write(sql_content)
