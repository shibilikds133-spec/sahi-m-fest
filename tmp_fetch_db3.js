...
async function check() {
  const url = 'https://szhwkngspodujiqzblab.supabase.co/rest/v1/registrations?select=id,item_id,participant_id,is_group_registration,raw_group_members,group_members(id,participant_id)&is_group_registration=eq.true&limit=5';
  const headers = {
