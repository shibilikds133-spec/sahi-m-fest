...
const stylesStartStr = `  card: {`;
const stylesEndStr = `  publishText: {
    color: 'white',
    fontWeight: '600',
    fontSize: 16,
  },`;
const stylesStart = code.indexOf(stylesStartStr);
const stylesEnd = code.indexOf(stylesEndStr, stylesStart) + stylesEndStr.length;
...
if (stylesStart !== -1 && stylesEnd !== -1) {
  ...
  code = code.substring(0, stylesStart) + replacementStyles + code.substring(stylesEnd);
